            ...
            <div class={[
                ...
                <div class="space-y-8">
                  ...
                  <div class="space-y-4">
                    ...
                    <button
                      ...
                      class={[
                        ...
                        @contexts.theme == "dark" && "bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white",
                        @contexts.theme == "light" && "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white"
                      ]}
                    >
                      <span class="group-hover:animate-pulse">
                        {if @contexts.theme == "dark", do: "☀️ Switch to Light", else: "🌙 Switch to Dark"}
                      </span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <button
                        ...
                        class={[
                          ...
                          @contexts.user_role != "guest" && "border-gray-300 hover:border-gray-400 hover:bg-gray-50"
                        ]}
                      >
                      ...
                      <button
                        ...
                        class={[
                          ...
                          @contexts.user_role != "user" && "border-green-300 hover:border-green-400 hover:bg-green-50"
                        ]}
                      >
                        <div class="text-center">
                          <div class="text-2xl mb-2">👨‍💼</div>
                      ...
                      <button
                        ...
                        class={[
                          ...
                          @contexts.user_role != "admin" && "border-red-300 hover:border-red-400 hover:bg-red-50"
                        ]}
                      >
                        <div class="text-center">
                          <div class="text-2xl mb-2">👑</div>
                  ...
                  <%= if @contexts.user_role in ["user", "admin"] do %>
                    <div class={[
                      ...
                      @contexts.theme == "dark" && "from-green-900/20 to-emerald-900/20 border-green-800/50"
                    ]}>
              ...
              <div class={[
                ...
                <ul class={[
                  ...
                  <li class="flex items-center">
                    <span class="w-2 h-2 bg-yellow-500 rounded-full mr-3 animate-pulse" style="animation-delay: 0.2s;"></span>
                  ...
                  <li class="flex items-center">
                    <span class="w-2 h-2 bg-pink-500 rounded-full mr-3 animate-pulse" style="animation-delay: 0.6s;"></span>
                    Zero prop drilling - contexts flow seamlessly between processes
                  </li>
                  <li class="flex items-center">
                    <span class="w-2 h-2 bg-indigo-500 rounded-full mr-3 animate-pulse" style="animation-delay: 0.8s;"></span>
